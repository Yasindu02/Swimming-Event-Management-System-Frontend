...
function Student() {
  const [values, setValues] = useState({
    ...
    address: "",
    phone: "",
    score_id:localStorage.getItem("score_id"),
  });
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`${API_BASE_URL}/api/Students/CreateStudent`, dataToSend)
      .then((res) => {
  ...
  return (
    <div
      className="student"
      style={{ backgroundColor: "#36454F", minHeight: "100vh" }}
    >
